...
<html>
  ...
  <body>
    <header class="p-3 bg-dark text-white">
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <b style="font-size:1.5em">DateFormatLocalizer</b>
        </div>
      </div>
    </header>
    <div class="container mt-5">
      <div class="row">
        <div class="col">
          <a href="https://github.com/lee-ratinan/dateFormatLocalizer" class="btn btn-warning mb-2" target="_blank">
        ...
        <div class="col col-lg-8">
            <?php if (in_array($page, ['php', 'javascript'])) : ?>
              ...
              <form method="POST">
                ...
                <input class="form-control mb-3" type="date" name="date" id="date_string" value="<?= @$date_string ?>"
